...
pub struct DepositInstructionsData {
    pub amount: u64,
}

impl<'a> TryFrom<&'a [u8]> for DepositInstructionsData {
    type Error = ProgramError;
...
pub struct Deposit<'a> {
    ...
    pub instruction_data: DepositInstructionsData,
}
...
impl<'a> TryFrom<(&'a [u8], &'a [AccountInfo])> for Deposit<'a> {
    ...
    fn try_from((data, accounts): (&'a [u8], &'a [AccountInfo])) -> Result<Self, Self::Error> {
        ...
        let instruction_data = DepositInstructionsData::try_from(data)?;
